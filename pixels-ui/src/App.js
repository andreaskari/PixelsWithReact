  ...
  render() {
    ...
    return (
      <div className="app ui grid">
        <div className="ui sixteen wide column header-container">
          <h1 className="website-name">Pixel Editor</h1>
        </div>
        <div className="ui sixteen wide column">
          <div className="pixel-content ui padded equal height grid">
            ...
            <div className="ui eight wide column pixel-container-outer">
